...
class Controller:
    ...
    def humidification_mode(self):
        """Returns one of HUMIDIFICATION_MODES indicating the current setting"""
    ...
    def humidification(self, setrh):
        ...
        self._data["humidification"]["value"] = setrh

    @humidification_mode.setter
    def humidification_mode(self, mode):
        if mode not in self._data["humidification"]["modes"]:
        ...
        query = """\
{
  me {
    ...
    def _get_equipment_status(self, controller_id) -> dict:
        query = """\
{
	"data": {
		"location": {
			...
			"statusIndoor": [
				{
					...
					"items": [
						...
						{
							"label": "FAULT LOG 1",
							"value": "HIGH LIMIT OPEN",
							"__typename": "StatusItem"
						},
						{
							"label": "FAULT LOG 2",
							"value": "AIR BLOCKAGE WARNIN",
							"__typename": "StatusItem"
						},
						{
							"label": "FAULT LOG 3",
							"value": "ROLLOUT OR AUX OPEN",
							"__typename": "StatusItem"
						},
						{
							"label": "FAULT LOG 4",
							"value": "PRESSURE SW OPEN",
							"__typename": "StatusItem"
						},
						{
							"label": "FAULT LOG 5",
							"value": "FLAME W/OUT POWER",
							"__typename": "StatusItem"
						}
					],
					"updatedAt": "2022-11-12T14:56:50.000Z",
					"__typename": "Status"
				}
			],
			...
			"statusOutdoor": [
				{
					...
					"items": [
						...
						{
							"label": "FLAME ROD CURRENT(uA)",
							"value": "3.9",
							"__typename": "StatusItem"
						},
						{
							"label": "INDUCER PRESSURE(in. of WC)",
							"value": "0.71",
							"__typename": "StatusItem"
						},
						{
						...
						{
							"label": "IGNITION RETRY(COUNT)",
							"value": "0",
							"__typename": "StatusItem"
						}
					],
					"updatedAt": "2022-11-12T14:57:05.000Z",
					"__typename": "Status"
				}
			],
			"statusZone": null
...
""":::::::::::::::::::::::::::::::::   EquipmentStatus Variables Query   :::::::::::::::::::::::::::::::::"""
"""{"operationName":"EquipmentStatus","variables":{"locationId":"AC000W000393092"},"query":"query EquipmentStatus($locationId: ID!)"""
